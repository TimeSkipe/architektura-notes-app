...
const SearchBlock = () => {
    ...
    return(
        <div className="h-[60px] lg:w-[50%] sm:w-[90%] bg-white rounded-[15px] absolute left-1/2 -translate-x-1/2 top-[170px] flex justify-between items-center px-5 shadow-[2px_2px_4px_rgba(0,0,0,0.25)]">
