...
const CreateNote = () =>{
    ...
    // CreateNote modal component form, that help to create a new note
    ...
    //ClearAll fun, cleaning function
    const ClearAll = () =>{
        setTitle("")
        setContent('')
        setCategory({})
    ...
    // CreateNoteFun, used to axios to request on server, to create a new note
