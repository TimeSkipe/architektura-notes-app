...
const NoteSetting = () =>{
    ...
    return(
        <div className={` ${OpenSetting ? "flex" : "hidden"}  absolute flex-col -bottom-[190px] right-1 bg-white shadow-[2px_2px_4px_rgba(0,0,0,0.25)] rounded-[15px] p-2`}>
            ...
            <div onClick={()=>{setReminderData(true);setOpenSetting(false)}} className="h-[43px] px-3 py-[2px] bg-[#F3F3F3] hover:bg-[#CFCFCF] cursor-pointer duration-300 ease-in-out shadow-[2px_2px_4px_rgba(0,0,0,0.25)] text-black rounded-[10px] mb-1 flex items-center">Add reminderDate</div>
            <div onClick={()=>{setCreatePasswordWindow(true); setOpenSetting(false)}} className="h-[43px] px-3 py-[2px] bg-[#F3F3F3] hover:bg-[#CFCFCF] cursor-pointer duration-300 ease-in-out shadow-[2px_2px_4px_rgba(0,0,0,0.25)] text-black rounded-[10px] mb-1 flex items-center">Add Password</div>
